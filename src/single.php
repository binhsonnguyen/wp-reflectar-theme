        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
          ...
          <small>
            <p><?php _e( 'Published', 'newcss' ); ?>
              <time><?php the_date(); ?></time><?php if ( get_the_modified_date() != get_the_date() ): ?> (<?php _e( 'updated', 'newcss' ); ?>:
                <time><?php the_modified_date(); ?></time>)<?php endif; ?> <?php _e( 'in', 'newcss' ); ?> <?php the_category( ', ' ); ?>
              . <?php if ( has_tag() ): ?><?php the_tags(); ?>.<?php endif; ?></p>
          </small>
			<?php
